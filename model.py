...
class SimpleTransformer(nn.Module):
    def __init__(self, dim, hidden_dim, num_embeddings, num_heads, num_layers, dropout):
        super().__init__()
    ...
    def forward(self, x):
        ...
        embeddings_output = token_embeddings + self.position_embeddings(positions).expand_as(tensor)
